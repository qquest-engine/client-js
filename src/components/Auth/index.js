...
class Auth extends React.Component {
  ...
  render() {
    return (
      <div>
      { !this.props.isLogged && <aside className="auth">
               
                { this.props.activeTab === 'login' && <Login onLogin={this.props.onLogin} values={this.state.values} errors={this.state.errors} onTab={this.props.onTab} />}
